...
@Component({
  selector: 'app-descuentos-por-cliente',
  templateUrl: './descuentos-por-cliente.component.html',
  styleUrls: ['./descuentos-por-cliente.component.css']
})

export class DescuentosPorClienteComponent {
